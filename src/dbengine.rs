...
pub const CLIENT_ALL_FLAGS: usize = CLIENT_LONG_PASSWORD | CLIENT_FOUND_ROWS | CLIENT_LONG_FLAG |
    ...
    CLIENT_IGNORE_SPACE | CLIENT_PROTOCOL_41 | CLIENT_INTERACTIVE | CLIENT_IGNORE_SIGPIPE |
    CLIENT_TRANSACTIONS | CLIENT_RESERVED | CLIENT_RESERVED2 | CLIENT_MULTI_STATEMENTS |
    CLIENT_MULTI_RESULTS | CLIENT_PS_MULTI_RESULTS | CLIENT_REMEMBER_OPTIONS |
...
pub const CLIENT_BASIC_FLAGS: usize =  CLIENT_ALL_FLAGS  & !CLIENT_COMPRESS ;
